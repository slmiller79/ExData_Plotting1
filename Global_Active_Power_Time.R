...
plot(subsetData$Time,as.numeric(as.character(subpower$Global_active_power)),type="l",xlab="",ylab="Global Active Power (kilowatts)") 

title(main="Global Active Power Vs Time")

png("Global Active Power vs Time", width=480, height=480)
dev.off()